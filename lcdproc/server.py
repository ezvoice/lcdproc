...
Server is the main object that needs to be instantiated.
It controls the session and you can apply a screen to it.
"""
...
class Server(object):
    ...
    def __init__(self, hostname="localhost", port=13666, debug=False):
        """Initialization method for the Server object; Sets up only the default connection paramters."""
        self.debug = debug
    ...
    def add_screen(self, ref):
        """Add a Screen to be displayed."""
        if ref not in self.screens:
            screen = Screen(self, ref)
            # TODO Check this is needed, new screens should be clear.
            screen.clear()
    ...
    def output(self, value):
        """Set the client's output parameter (on, off, int).
    ...
    def get_server_info(self):
        ...
        This method returns information about the server and the connected
